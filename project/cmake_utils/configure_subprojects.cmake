...
function(configure_subprojects main_project_name out_link_libraries)
    get_filename_component(abs_source_dir "../src/" REALPATH)
    gather_subdirs(subdirs ${abs_source_dir})
    foreach(subdir ${subdirs})
        set(subproject_name ${subdir})
        set(file_excludes ".*\\.tests.*")
		fill_platform_excludes(platform_excludes)
		list(APPEND file_excludes ${platform_excludes})
		gather_files(header_files true "../include/${main_project_name}/${subdir}/*.h;../include/${main_project_name}/${subdir}/*.inl;../src/${subdir}/*.h" "${file_excludes}")
        gather_files(src_files true "../src/${subdir}/*.cpp" "${file_excludes}")
        set(tokens_to_erase ${main_project_name})
        setup_visual_studio_filters("${tokens_to_erase}" header_files)
        setup_visual_studio_filters("${tokens_to_erase}" src_files)
        ...
        set_target_properties(${subproject_name} PROPERTIES LINKER_LANGUAGE CXX FOLDER "${main_project_name}.internal")
    endforeach()
