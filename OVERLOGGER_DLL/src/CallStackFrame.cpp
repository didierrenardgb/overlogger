...
namespace olg {
	...
	struct CallStackFrame::CallStackFrameImpl {
		...
		CallStackFrameImpl(unsigned long long address, const std::string& functionName, const std::string& sourceFileName,
            unsigned long codeLine) : mAddress{address}, mFunctionName(functionName), mSourceFileName(sourceFileName), mCodeLine(codeLine) {}
	...
	CallStackFrame::CallStackFrame(unsigned long long address, const std::string& functionName, const std::string& sourceFileName,
		unsigned long codeLine) :mImpl(std::make_unique<CallStackFrameImpl>(address, functionName, sourceFileName, codeLine)) {
